...
const bancoPerguntas = [
    { pergunta: "Qual a composição básica do solo?", opcoes: ["Minerais, matéria orgânica, água e ar", "Apenas pedras e areia"], correta: 0 },
    { pergunta: "O que é Húmus?", opcoes: ["Matéria orgânica decomposta", "Um tipo de agrotóxico"], correta: 0 },
    { pergunta: "Qual solo retém mais água?", opcoes: ["Solo Arenoso", "Solo Argiloso"], correta: 1 },
    { pergunta: "O que evita a erosão do solo?", opcoes: ["Plantio em curvas de nível", "Desmatamento"], correta: 0 },
    { pergunta: "O que é rotação de culturas?", opcoes: ["Alternar espécies no mesmo terreno", "Plantar sempre a mesma coisa"], correta: 0 },
    { pergunta: "Qual elemento é um macronutriente primário das plantas?", opcoes: ["Nitrogênio (N)", "Alumínio (Al)"], correta: 0 },
    { pergunta: "Qual a função da calagem no solo?", opcoes: ["Reduzir a acidez do solo", "Aumentar a quantidade de pragas"], correta: 0 },
    { pergunta: "O que são plantas de cobertura?", opcoes: ["Especialmente usadas para proteger o solo", "Plantas ornamentais de casa"], correta: 0 },
    { pergunta: "Como a irrigação por gotejamento ajuda?", opcoes: ["Economiza água aplicando direto na raiz", "Molha o terreno todo sem controle"], correta: 0 },
    { pergunta: "O que caracteriza a adubação verde?", opcoes: ["Uso de plantas para enriquecer o solo", "Pintar as plantas de verde"], correta: 0 },
    { pergunta: "O que é a compactação do solo?", opcoes: ["Perda de porosidade que dificulta as raízes", "Adição de adubo natural"], correta: 0 },
    { pergunta: "Qual inseto é considerado um polinizador vital?", opcoes: ["Abelha", "Lagarta"], correta: 0 },
    { pergunta: "O que é agroecologia?", opcoes: ["Agricultura sustentável sem químicos nocivos", "Produção industrial de agrotóxicos"], correta: 0 },
    { pergunta: "O que indica o pH do solo?", opcoes: ["Grau de acidez ou alcalinidade", "A quantidade de pedras"], correta: 0 },
    { pergunta: "O que faz a enxada rotativa?", opcoes: ["Prepara e descompacta o solo agrícola", "Corta árvores grandes"], correta: 0 }
];
